...
class apiactionlog_command_retry extends base_shell_prototype{
    ...
    function command_fail_retry(){
        ...
        $loglist = (array) $objApilog->db->select("select * from sdb_apiactionlog_apilog where status ='fail' and api_type='request' and retry<=3 ORDER BY `last_modified` DESC limit 0,1000");
