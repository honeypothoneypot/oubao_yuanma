...
class base_errorpage {
    ...
    private static function _var_export($text) {
        ob_start();
        var_dump($text);
...
EOF;
    ...
    public static function system_crash() {
        self::output('', '服务异常稍后再试55');
    }

    public static function system_offline() {
        self::output('', 'System is offline');
    }

    protected static function output($body, $title = '', $status_code = 500) {
