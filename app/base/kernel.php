...
class kernel {
    ...
    private static $__online             = null;
    private static $__router             = null;
    private static $__db_instance        = null;
    private static $__singleton_instance = array();
    private static $__request_instance   = null;
    private static $__single_apps        = array();
    private static $__service_list       = array();
    private static $__base_url           = array();
    private static $__language           = null;
    private static $__service            = array();
    private static $__require_config     = null;
    private static $__host_mirrors       = null;
    private static $__host_mirrors_count = null;
    ...
    public static function this_url($full = false) {
        return self::base_url($full) . self::url_prefix() . self::request()->get_path_info();
    }

    private static function get_host_mirror() {
    ...
    public static function get_resource_host_url($local_flag = false) {
    ...
    public static function get_themes_host_url($local_flag = false) {
    ...
    public static function get_app_statics_host_url($local_flag = false) {
    ...
    public static function set_online($mode) {
        self::$__online = $mode;
    }
    ...
    public static function single($class_name, $arg = null) {
        if ($arg === null) {
    ...
    public static function service($srv_name, $filter = null) {
        return self::servicelist($srv_name, $filter)->current();
    }

    public static function servicelist($srv_name, $filter = null) {
        if (self::is_online()) {
    ...
    public static function strip_magic_quotes(&$var) {
        foreach ($var as $k => $v) {
            if (is_array($v)) {
    ...
    public static function register_autoload($load = array('kernel', 'autoload')) {
    ...
    public static function unregister_autoload($load = array('kernel', 'autoload')) {
        if (function_exists('spl_autoload_register')) {
    ...
    public static function set_lang($language) {
