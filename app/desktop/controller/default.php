...
class desktop_ctl_default extends desktop_controller {
    ...
    public $workground = 'desktop_ctl_dashboard';
    ...
    public function setEncode($sess_id, $certi_id) {
    ...
    public function main_menu_define() {
        $desktop_user = kernel::single('desktop_user');
    ...
    public function desktop_events() {
